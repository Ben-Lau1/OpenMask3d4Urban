...
# pip install pytorch-lightning==2.2.2 fire==0.5.0 imageio==2.23.0 tqdm==4.64.1 wandb==0.13.2
# pip install python-dotenv==0.21.0 pyviz3d==0.2.32 scipy==1.9.3 plyfile==0.7.4 scikit-learn==1.2.0 trimesh==3.17.1 loguru==0.6.0 
...
# pip install albumentations==1.3.0 
# pip install volumentations==0.1.8
pip install antlr4-python3-runtime black==21.4b2 omegaconf hydra-core --no-deps

pip install 'git+https://github.com/facebookresearch/detectron2.git@710e7795d0eeadf9def0e7ef957eea13532e34cf' --no-deps

# pip install -y openblas-devel -c anaconda
pip install -U git+https://github.com/NVIDIA/MinkowskiEngine -v --no-deps --config-settings="--blas_include_dirs=${CONDA_PREFIX}/include" --config-settings="--blas=openblas" 
