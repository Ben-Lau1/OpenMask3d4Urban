...
export PYTHONPATH=$PYTHONPATH:$SCRIPT_DIR:$SCRIPT_DIR/class_agnostic_mask_computation
set -e
...
# ------------------------------------------------------------------
# data paths
SCENE_DIR="/home/zhangshuai/workshop/open_vocabulary/openmask3d/scene_example"
SCENE_POSE_DIR="${SCENE_DIR}/pose"
SCENE_INTRINSIC_PATH="${SCENE_DIR}/intrinsic/intrinsic_color.txt"
SCENE_INTRINSIC_RESOLUTION="[968,1296]" 
...
# model ckpt paths
MASK_MODULE_CKPT_PATH="/home/zhangshuai/workshop/open_vocabulary/openmask3d/scannet200_val.ckpt"
SAM_CKPT_PATH="/home/zhangshuai/workshop/open_vocabulary/openmask3d/sam_vit_h_4b8939.pth"
...
hydra.run.dir="${OUTPUT_FOLDER_DIRECTORY}/class_agnostic_mask_computation" \
data.voxel_size=0.05 \
+data.test_num_points=50000 
echo "[INFO] Mask computation done!"

# 注意：上面两行 data.voxel_size=0.05 和 data.test_num_points=50000 是新增的
# 0.05 (5cm) 比默认的 0.02 更稀疏，大幅降低显存
# 50000 限制最大点数，防止 4090 爆显存
